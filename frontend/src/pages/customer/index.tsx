      ...
      <>
         <header className=" flex flex-row justify-between py-6 px-96">
            <div className="flex flex-row space-x-6 items-center">
               <NavLink
                  to="/abc"
                  className={({ isActive }) => (isActive ? "font-medium text-black" : "text-primary-gray")}>
                  Quản lý tài khoản
               </NavLink>
               <NavLink
                  to="/abc"
            ...
            <div className="flex flex-row space-x-3 items-center">
               ...
               <Avatar src="https://api.dicebear.com/7.x/miniavs/svg?seed=1" className="bg-gray-200" size={"large"} />
            </div>
         </header>
         <Separator />
