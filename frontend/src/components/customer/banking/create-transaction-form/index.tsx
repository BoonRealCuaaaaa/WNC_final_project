...
export default function CreateTransactionForm({onCreateSuccess, paymentTransaction}: Props) {
    // 1. Define your form.
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <div>
                                                <Input placeholder="Nhập số tài khoản người nhận tiền..." {...field} type="number" onBlur={(event) => mutateReceiver(event.target.value)}/>
