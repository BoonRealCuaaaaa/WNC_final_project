...
const BankingResult = ({receiverName, amount}: {receiverName: string; amount: number}) => {
  ...
  return (
    <div className="w-[700px] mx-auto bg-white p-6 rounded-lg border-gray-300 border text-center">
      {/* Title */}
      <h1 className="text-xl font-bold text-gray-800 mb-2 text-left">Kết quả chuyển tiền</h1>
      {/* Subtitle */}
      ...
      <p className="text-gray-600 mb-6">{receiverName} đã nhận được {amount}đ từ bạn</p>
      {/* Checkbox */}
      ...
      <Button variant="outline-primary" className="w-full" onClick={handleButtonClick}>Quay về trang quản lý tài khoản</Button>
