...
export default function AddBeneficiaryForm({
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    mutateCreateBeneficiary({
      bankName,
      accountNumber,
      remindName: remindName !== "" ? remindName : recevier,
    });
  }
  ...
  const fullBankNames = [import.meta.env.VITE_BANK_NAME, ...bankNames];

  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="dialog-form">
        <DialogHeader>
          <DialogTitle>Thêm người thụ hưởng</DialogTitle>
        </DialogHeader>
        <FormMainContent>
          <FormHorizontalGroupFields>
            <FormField
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder={recevier ?? "Nhập tên gợi nhớ..."}
                    {...field}
                  />
                </FormControl>
                <FormMessage />
